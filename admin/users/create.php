            ...
            <!-- MAIN_CONTENT START -->
                <div class="main-content pb-1rounded-2">
                    <div class="title row justify-content-between">
                        <h2 class="col-md-8 title_create_user">Создать пользователя</h2>
                    ...
                    <div class="row add-post reg_form">
                        ...
                        <form action="create.php" method="post">
                            <div class="col mb-3"> 
                                ...
                                <input name="login" value="" type="text" class="contact-input rounded-2" id="formGroupExampleInput" placeholder="Введите логин" require>
                            </div>
                            ...
                            <div class="form-check mt-4 ms-1">
                                <input name="publish" class="form-check_edit form-check-input" type="checkbox" value="1" id="flexCheckChecked">
                                <label class="form-check-label" for="flexCheckChecked">Admin?</label>
                            </div>

                            <div class="block_btn pt-2 mt-3">
                                <button  name="create-user" type="submit" class="btn p-3">
                                    <i class="fa-solid fa-user-pen"></i> Создать пользоватлея
                                </button>
                            </div>
                        </form>
                    </div>
