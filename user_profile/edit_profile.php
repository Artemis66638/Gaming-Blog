<?php 
    ...
    session_start();
    include SITE_ROOT . "/app/controllers/user_proffile.php";
?>
            ...
            <!-- MAIN_CONTENT START -->
                <div class="main-content pb-1rounded-2">
                    <div class="title row justify-content-between">
                        <h2 class="col-md-8 title_edit_user">Редактирования профиля</h2>
                    ...
                    <div class="row add-post reg_form">
                        ...
                        <form action="edit_profile.php" method="post">
                            ...
                            <div class="col">
                                <label for="exampleInputPassword2" class="form-label">Повторитe пароль</label>
                            ...
                            <div class="block_btn pt-2 mt-3">
                                <button name="update-user" class="btn p-3">
                                    <i class="fa-solid fa-user-pen"></i> Редактировать профиль
                                </button>
                            </div>
                        </form>
                    </div>
