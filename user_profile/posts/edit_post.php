            ...
            <!-- MAIN_CONTENT START -->
                <div class="main-content pb-1 rounded-2">
                    <div class="title row justify-content-between">
                        <h2 class="col-md-4 title_create">Редактировать пост</h2>

                        <div class="button col-md-2">
                            <a href="<?= BASE_URL . "user_profile/posts/index.php";?>" class=" btn">Назад</a>
                        </div>
                    </div>
                    ...
                    <div class="row add-post contnet_post">
                        ...
                        <form action="create_post.php" method="post" enctype="multipart/form-data">
                            ...
                            <input value="<?=$post['title']; ?>" type="text" name="title" class="text-input rounded-2" id="title" placeholder="Заголовок поста" require>
                            ...
                            <input type="hidden" name="stat_img" value="<?=$post['img']; ?>">
                            ...
                            <div class="block_btn pt-2 mt-3">
                                <button name="edit_post" name="add_post" onclick="exportText()" type="submit" class="btn p-3">
                                    <i class="fa-solid fa-plus"></i> Редактировать пост
                                </button>
